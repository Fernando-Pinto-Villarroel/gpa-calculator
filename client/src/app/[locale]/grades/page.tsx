...
import { ActionsMenu } from "@/features/config/components/ActionsMenu";
...
import { EspGradesView } from "@/features/esp/components/EspGradesView";
...
export default function ConfigPage() {
  ...
  if (selectedCareerId === "esp") {
    return <EspGradesView />;
  }
